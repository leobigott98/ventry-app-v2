...
import { idempotencyKeySchema, manualVehicleEntrySchema } from "@/lib/schemas/guards";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json(
      { error: "No fue posible registrar el vehiculo. Verifica los datos e intenta nuevamente." },
      { status: 409 },
    );
  }
}
