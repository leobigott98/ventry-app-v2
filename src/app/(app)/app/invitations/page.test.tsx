...
const invitationMocks = vi.hoisted(() => ({
  ...
  getInvitationGroupSummaries: vi.fn(),
}));
...
vi.mock("@/lib/domain/invitations", () => {
  return {
    ...
    getInvitationGroupSummaries: invitationMocks.getInvitationGroupSummaries,
  };
});

describe("InvitationsPage pagination and filters", () => {
  beforeEach(() => { invitationMocks.getPaginatedInvitations.mockResolvedValue({ items: [], page: 2, pageSize: 10, total: 0, totalPages: 1 }); invitationMocks.getInvitationGroupSummaries.mockResolvedValue(new Map()); });
