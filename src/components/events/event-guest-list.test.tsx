...
function guest(id: string, status: EventGuestRecord["attendance_status"], shared = false): EventGuestRecord {
  return { id, event_id: "event-1", full_name: `Persona ${id}`, phone: null, notes: null, allows_companions: false, max_companions: 0, credential_shared_at: shared ? "2026-08-21T00:00:00.000Z" : null, attendance_status: status, checked_in_at: null, checked_out_at: null, created_at: "2026-08-21T00:00:00.000Z", updated_at: "2026-08-21T00:00:00.000Z" };
}

function credential(id: string): EventGuestCredentialRecord {
  return { id: `credential-${id}`, event_id: "event-1", event_guest_id: id, credential_type: "qr", credential_value: `value-${id}`, qr_payload: `payload-${id}`, credential_audit_id: `audit-${id}`, share_token: `share-${id}`, created_at: "2026-08-21T00:00:00.000Z" };
}
